...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler registration_accumulate_kernel_sparsemux_13_3_64_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}

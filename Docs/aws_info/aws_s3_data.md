...
| `fpga/weights/int8/` | `fpga/weights/int8/` | 49 MB | INT8 per-layer weight tensors and per-channel scale files for the FPGA quantized path |
...
aws s3 sync s3://sgslam-data-448792657895/fpga/golden_vectors/ fpga/golden_vectors/
aws s3 sync s3://sgslam-data-448792657895/fpga/weights/        fpga/weights/
aws s3 sync s3://sgslam-data-448792657895/fpga/weights/int8/   fpga/weights/int8/
```
